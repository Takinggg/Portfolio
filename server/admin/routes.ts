 ...
 */
export function initializeAdminSchedulingRoutes(
  ...
  const logAdminAction = (req: any, action: string, resourceType: string, resourceId?: string, oldValues?: any, newValues?: any) => {
  ...
  router.get('/availability-rules', (req, res) => {
    try {
      ...
      if (event_type_id) {
        ...
        params.push(parseInt(event_type_id as string));
      }
