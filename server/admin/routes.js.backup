...
// Apply rate limiting, configuration checks, and auth to all admin routes except health
router.use('/health', (req, res, next) => next()); // Health endpoint bypasses all checks
router.use(adminRateLimit);
router.use(checkAdminConfiguration);
