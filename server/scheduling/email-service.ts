...
import { Booking, EventType, Invitee, Notification } from './types.js';
...
export class EmailNotificationService {
  ...
  constructor(db: Database.Database, fromEmail: string = 'noreply@maxence.design') {
    this.db = db;
  ...
  private markNotificationSent(notificationId: number): void {
    this.db.prepare(`
  ...
  private markNotificationFailed(notificationId: number, errorMessage: string): void {
    this.db.prepare(`
      UPDATE notifications 
...
<body>
  ...
  private generateBookingConfirmationText(data: any): string {
    return `
Booking Confirmed!
...
`;
  ...
  private generateCancellationHTML(data: any): string {
    return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  private generateCancellationText(data: any): string {
    return `
Booking Cancelled
...
`;
  ...
  private generateRescheduleHTML(data: any): string {
    return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  private generateRescheduleText(data: any): string {
    return `
Booking Rescheduled
