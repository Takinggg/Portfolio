...
export class EmailTemplates {
     ...
     */
    static getLocationDescription(locationType) {
        switch (locationType) {
            case 'visio':
...
`.trim();
    ...
    static getConfirmationHtmlTemplate() {
...
`.trim();
    ...
    static getRescheduleHtmlTemplate() {
...
`.trim();
    ...
    static getCancellationHtmlTemplate() {
...
<body>
     ...
     * Reminder Templates
     */
    static getReminderSubject(variables, hoursUntil) {
    ...
    static getReminderTextTemplate() {
...
`.trim();
    ...
    static getReminderHtmlTemplate() {
...
<body>
     ...
     */
    static renderConfirmation(variables) {
     ...
     */
    static renderReschedule(variables) {
     ...
     */
    static renderCancellation(variables) {
     ...
     */
    static renderReminder(variables, hoursUntil) {
