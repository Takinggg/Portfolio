...
- ✅ New backend: `https://back.maxence.design/api` (custom domain)
- 🔄 Fallback: `https://takinggg-portfolio-backend.onrender.com/api` (Render default)
...
1. **DNS Configuration:**
   - Create a CNAME record: `back.maxence.design` → `takinggg-portfolio-backend.onrender.com`
