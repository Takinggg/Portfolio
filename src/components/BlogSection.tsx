...
const getBlogPlaceholderImage = () => {
  return 'data:image/svg+xml;base64,';
};
...
const BlogSection: React.FC<BlogSectionProps> = ({ onNavigateToBlog, onNavigateToPost }) => {
  ...
  // Debug logging
  useEffect(() => {
    console.log('BlogSection - Posts loaded:', featuredPosts.length);
          ...
          {featuredPosts.map((post, index) => (
            ...
            >
              ...
              <div className={`relative ${index === 0 ? 'h-80' : 'h-48'} overflow-hidden`}>
                <img 
                  src={post.featured_image || getBlogPlaceholderImage()}
                  alt={post.title}
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <button 
                ...
                className="bg-white dark:bg-gray-800 text-purple-600 dark:text-purple-400 px-8 py-4 rounded-2xl font-semibold text-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 transform hover:scale-105 shadow-xl flex items-center gap-2 mx-auto"
              >
                {t('blog.view_all')}
                <ArrowRight size={20} />
              </button>
